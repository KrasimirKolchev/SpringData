...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("select distinct u from com.productsshopxml.persistence.models.entities.User u " +
            "join com.productsshopxml.persistence.models.entities.Product p on u.id = p.seller.id " +
